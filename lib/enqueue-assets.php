...
function cowboy_assets() {
    ...
    wp_enqueue_script( 'cowboy-script', get_template_directory_uri() . '/dist/assets/js/bundle.js', array('jquery'), '1.0.0', true);
}
...
function cowboy_admin_assets() {
    ...
    wp_enqueue_script( 'cowboy-admin-script', get_template_directory_uri() . '/dist/assets/js/admin.js', array(), '1.0.0', true);
}
